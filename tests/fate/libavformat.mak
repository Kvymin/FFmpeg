...
FATE_LIBAVFORMAT-$(CONFIG_HLS_DEMUXER) += fate-hls_ad_plan fate-hls_timestamp
fate-hls_ad_plan: libavformat/tests/hls_ad_plan$(EXESUF)
fate-hls_ad_plan: CMD = run libavformat/tests/hls_ad_plan$(EXESUF)
fate-hls_ad_plan: CMP = null
