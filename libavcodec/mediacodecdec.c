                                            ...
                                            AVFrame *frame)
{
    ...
    if (s->hevc_sei.common.dynamic_hdr_plus.info) {
        AVBufferRef *info =
            av_buffer_ref(s->hevc_sei.common.dynamic_hdr_plus.info);
